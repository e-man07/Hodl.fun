...
- **Creator Fees**: 30% of trading fees go to token creators
- **Liquidity Reserve**: 20% of fees accumulated for deeper DEX liquidity at graduation
- **Deflationary**: Excess tokens burned at graduation
...
═══════════════════════════════════════════════════════════════════════════════
  ...
  │ 5. Tokens transferred to user   │  │    • 20% → Liquidity Reserve      │
  │ 6. Reserves updated             │  │    • 30% → Creator (accumulated)  │
  │ 7. ATH checked/updated          │  │    • 50% → Platform (FeeVault)    │
  └─────────────────────────────────┘  │ 5. PUSH transferred to user       │
                                       │ 6. Reserves updated               │
                                       └───────────────────────────────────┘
                                    │
                                    ▼
...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Anyone calls BondingCurve.listing()
                                    ...
                                    ▼
  ┌─────────────────────────────────────────────────────────────────────────┐
  │ 1. Excess tokens BURNED (deflationary)                                  │
  │ 2. Create Uniswap V3 pool (token/WPUSH)                                 │
  │ 3. Calculate liquidity with ADAPTIVE V3 RANGE (0.25x to 4x)             │
  │ 4. Add concentrated liquidity at current price                          │
  │ 5. LP is PERMANENTLY LOCKED (no withdrawal function exists)             │
  │ 6. Listing fee (0.1 PUSH) sent to FeeVault                              │
  │ 7. Mark curve as listed                                                 │
  └─────────────────────────────────────────────────────────────────────────┘
                                    │
                                    ▼
                           Events Emitted:
...
│   │   └── TimelockAdmin.t.sol      # Timelock tests (17)
│   │
│   ├── fuzz/                        # 10 fuzz tests
...
│   │
│   ├── security/                    # 94 security tests
│   │   ├── GasLimitAttack.t.sol     # Gas limit attacks (13)
│   │   ├── ReentrancyAttack.t.sol   # Reentrancy tests (12)
│   │   ├── FlashLoanAttack.t.sol    # Flash loan tests (10)
│   │   └── AccessControlAttack.t.sol # Access control (33)
│   │
│   ├── stress/                      # 26 stress tests
...
│   └── TransferAdminToTimelock.s.sol # Admin transfer
│
